...
**NO crear archivo `-request.ts` para:**
- Endpoints GET sin body
- Endpoints que solo usan path params o query params

**SÍ crear archivo `-request.ts` para:**
- POST con body
- PUT con body
- PATCH con body

```typescript
// product-request.ts (solo si se envían datos)
...
Antes de finalizar un servicio HTTP, verificar:
